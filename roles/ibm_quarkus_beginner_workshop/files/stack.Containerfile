# To build this stack:
# docker build -t quay.io/ibm/quarkus-workshop-devspace:ibm-3.27 -f stack.Containerfile .
# docker push quay.io/ibm/quarkus-workshop-devspace:ibm-3.27
...
RUN sudo rpm -Uvh https://dl.fedoraproject.org/pub/epel/epel-release-latest-9.noarch.rpm && sudo microdnf install -y zlib-devel gcc siege gcc-c++ && sudo curl -Lo /usr/bin/jq https://github.com/stedolan/jq/releases/download/jq-1.8.1/jq-linux64 && sudo chmod a+x /usr/bin/jq
